...
function cutpic($logopic ,$photopic ,$lux,$luy,$width,$height)
 ...
 function getInfo($file) 
 {
  ...
  function scaleMin($sourFile , $newName , $width=200,$height=200,$zoomtype=0) 
 {
  $imageInfo =$this->getInfo($sourFile);
  switch ($imageInfo["type"])
  {
...
$cutW = 200;
$cutH = 150;
$g->scaleMin($img,"temp.jpg",$width,$width);

$pinfo = $g->getInfo("temp.jpg");
...
$g->cutpic("temp.jpg",$saveimg,$x,$y,$cutW,$cutH);
*/
