...
// 修改资料
	...
	public function ajaxGetLoginBar(){
		//$p = A("Public","User");
		//$p->loginedbar();
		$r = getUserInfo();
		if(is_array($r)){
			$this->assign('u',$r);
			echo $this->fetch(MMM_ROOT."/User/Tpl/default/Public/loginedbar.html");
		}
		//exit;
		//loginedbar();
		//$url = "http://u.".DOMAIN."/public/loginedbar";
		//echo $url;
