...
class SupplyAction extends CommonAction {
	...
	function replacePublic($r){
		...
		$r['property'] = $this->enum->getSelect('property', 'property', $r['property'],'key');
		//echo $this->enum->getSelect('property', 'property', $r['property'],'key');
	...
	function update(){
		!$_POST['top'] ? $_POST['top'] = 0 : '';
		!$_POST['hot'] ? $_POST['hot'] = 0 : '';
		!$_POST['up'] ? $_POST['up'] = 0 : '';
