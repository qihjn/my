...
<br />
	...
	<tr>
	  <th style="width:12em;">下载(缩略图)</th>
	  <td><select name="download_thumb_status" id="thumb_status4">
	    ...
	    <input type="text" name="download_thumb_size" value="<?php echo ($vo["download_thumb_size"]); ?>" size="20" />
	    宽,高(像素)</td>
	  </tr>
	</table>
	<br />
