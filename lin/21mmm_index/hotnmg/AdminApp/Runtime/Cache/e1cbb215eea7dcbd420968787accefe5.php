...
{
	$("#verifyImage").attr('src', "<?php echo U('Public/verify',0,0,0);?>__"+ Math.random());
}
...
<p class="footer">Powered by <a href="http://www.sgcms.cn" target="_blank">shuguangCMS</a> &copy; 2001 - 2008 <a href="http://www.sgcms.cn" target="_blank">shuguang.</a></p>
</body>
</html>