	...
	<div class="body_content">
       ...
       <tbody id="root_0" <?php if($parentId == 0): ?>style="display:"<?php else: ?>style="display:none"<?php endif; ?>>
        <tr>
          ...
          <?php if(is_array($module)): $i = 0; $__LIST__ = $module;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): ++$i;$mod = ($i % 2 )?><option value="<?php echo ($row["module_name"]); ?>"><?php echo ($row["module_title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		  </select></td>
		  </tr>
           </tbody>
		<tr>
