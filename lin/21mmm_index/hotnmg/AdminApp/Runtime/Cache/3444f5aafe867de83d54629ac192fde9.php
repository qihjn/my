    ...
    <span style=" font-weight:bold"><label for="market_price">市 场 价</label></span>
      ...
      只能填写数字(单位:元)</td></tr>
        ...
        <tr>
          ...
          <td> <input name="attach_file" type="file" id="attach_file" /><?php if(($vo['attach'])  ==  "1"): ?>不更换请不要选择新图片　<a href="__ROOT__/<?php echo ($UPLOADS); ?><?php echo ($vo["attach_image"]); ?>" target="_blank"><img src="__PUBLIC__/Admin/image.gif" border="0" align="absmiddle" /></a><?php endif; ?></td></tr>
         <tr>
