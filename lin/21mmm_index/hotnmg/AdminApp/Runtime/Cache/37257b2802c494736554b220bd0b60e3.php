...
*/
	...
	<table cellspacing="0" cellpadding="0"  id="maintable" class="formtable">
        ...
        <td style="text-align:left">
          ...
          <?php echo (statusIcon($vo["status"],1,$frontUrl,'hidden.gif','隐藏')); ?><?php echo (statusIcon($vo["istop"],1,$frontUrl,'istop.gif','置顶')); ?><?php echo (statusIcon($vo["recommend"],1,$frontUrl,'recommend.gif','推荐')); ?><?php echo (attachStatus($vo["attach_image"],1,$frontUrl,'image.gif','图片')); ?>      
          </td>
        <td><?php echo ($vo["category"]); ?></td>
        <td><?php echo (date("Y-m-d",$vo["create_time"])); ?></td>
		<td> <a href="<?php echo U('Product/modify',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/Admin/modify22px.gif" alt="编辑" align="absmiddle" /></a></td>
