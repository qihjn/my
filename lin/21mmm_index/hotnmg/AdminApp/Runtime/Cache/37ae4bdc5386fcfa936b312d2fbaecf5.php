...
<form method="post" action="<?php echo U("News/doModify");?>" enctype="multipart/form-data" id="mainFrom">
	<div class="body_content">
		...
		<?php if(($vo['attach'])  ==  "1"): ?>不更换请不要选择新图片　<a href="__ROOT__/<?php echo ($UPLOADS); ?><?php echo ($vo["attach_image"]); ?>" target="_blank"><img src="__PUBLIC__/Admin/image.gif" border="0" align="absmiddle" /></a>　<input name="deleteImage" type="radio" value="1" />转换为普通新闻<?php endif; ?></td></tr>
         <tr>
