...
<div class="title">
			...
			<table id="maintable" class="formtable">
				...
				<tr>
				  <td>产品网站</td>
				  <td><a href="http://www.sgcms.cn" target="_blank">http://www.sgcms.cn</a></td>
			  </tr>
			</table>
...
<script language="javascript" src="http://www.sgcms.cn/update.php?app=shuguangCorp&info=<?php echo ($update); ?>"></script>