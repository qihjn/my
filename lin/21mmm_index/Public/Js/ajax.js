...
function Ajax(recvType, waitId) {
	...
	aj.processHandle = function() {
		//alert(aj.XMLHttpRequest.readyState+","+aj.XMLHttpRequest.status);
	...
	aj.get = function(targetUrl, resultHandle) {
		...
		var delay = attackevasive & 1 ? (aj.stackId + 1) * 101 : 100;
		if(window.XMLHttpRequest) {
			setTimeout(function(){
			...
			setTimeout(function(){
			aj.XMLHttpRequest.open("GET", targetUrl+"&"+Math.random(), true);
	...
	aj.post = function(targetUrl, sendString, resultHandle) {
		...
		aj.XMLHttpRequest.onreadystatechange = aj.processHandle;
		aj.resultHandle = resultHandle;
		aj.XMLHttpRequest.open('POST', targetUrl+"&"+Math.random());
